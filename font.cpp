...
//		TRACE("'%C':%s\n", text[i], ind.ToString().c_str());
		...
		verts->push_back(VertexPCT(xPos,      yPos + h, 0.0f,	 u0,0.0f,1.0f,v0,		u0, v0));
		verts->push_back(VertexPCT(xPos,      yPos,     0.0f,	 u0,0.0f,1.0f,v1,		u0, v1));
		verts->push_back(VertexPCT(xPos + w,  yPos,     0.0f,	 u1,0.0f,1.0f,v1,		u1, v1));
		verts->push_back(VertexPCT(xPos,      yPos + h, 0.0f,	 u0,1.0f,0.0f,v0,		u0, v0));
		verts->push_back(VertexPCT(xPos + w,  yPos,     0.0f,	 u1,1.0f,0.0f,v1,		u1, v1));
		verts->push_back(VertexPCT(xPos + w,  yPos + h, 0.0f,	 u1,1.0f,0.0f,v0,		u1, v0));
